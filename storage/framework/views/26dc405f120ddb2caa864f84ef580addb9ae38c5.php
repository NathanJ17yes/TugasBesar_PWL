...
if (isset($messageCache)) { $message = $messageCache; }
            ...
            <div class="input-group mb-3">
                ...
                placeholder="Role" name="role" required autocomplete="role" autofocus>
                <div class="input-group-append input-group-text">
                    <span class="fa fa-user"></span>
                </div>
            </div>
            ...
            <div class="input-group mb-3">
                <input id="gender" type="text" class="form-control"
                       placeholder="Gender" name="gender" required autocomplete="gender" autofocus>
                <div class="input-group-append input-group-text">
                    <span class="fa fa-user"></span>
                </div>
            </div>
...
<?php echo $__env->make('auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TugasBesar_PWL-main\resources\views/auth/register.blade.php ENDPATH**/ ?>